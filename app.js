...
var turn = 1;
  ...
  var config = {
    apiKey: "AIzaSyA7PjCwXHnLJC6EcS4gDsy4M484qScR4R0",
    authDomain: "rps-chat-cbc18.firebaseapp.com",
    databaseURL: "https://rps-chat-cbc18.firebaseio.com",
    projectId: "rps-chat-cbc18",
    storageBucket: "",
    messagingSenderId: "685609971243"
  };
...
function rpsCompare() {
	if (player1.choice === "Rock") {
		...
		if (player2.choice === "Rock") {
			...
			database.ref().child("/outcome/").set(player1Name + "'s Paper wins!");
			database.ref().child("/players/player1/win").set(player1.win + 1);
			database.ref().child("/players/player2/loss").set(player2.loss + 1);
		} else if (player2.choice === "Paper") {
			// Tie
